            ...
            <div className="w-full lg:w-7/12">
              ...
              <div className="flex flex-row sm:flex-col flex-wrap gap-4 sm:gap-12">
                <div className="flex flex-col sm:flex-row gap-4">
                    <div className="flex items-start">
                        <div className="shrink-0 bg-slate-100 rounded-lg p-3">
                            <HiOutlineIdentification size={35} color="black"></HiOutlineIdentification>
                        </div>
                        <div className="pl-4">
                    ...
                    <div className="flex items-start">
                        <div className="shrink-0 bg-slate-100 rounded-lg p-3">
                            <HiOutlineSearchCircle size={35} color="black"></HiOutlineSearchCircle>
                        </div>
                        <div className="pl-4">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <div className="flex items-start">
                        <div className="shrink-0 bg-slate-100 rounded-lg p-3">
                            <HiOutlineQrcode size={35} color="black"></HiOutlineQrcode>
                        </div>
                        <div className="pl-4">
                    ...
                    <div className="flex items-start">
                        <div className="shrink-0 bg-slate-100 rounded-lg p-3">
                            <HiOutlinePencilAlt size={35} color="black"></HiOutlinePencilAlt>
                        </div>
                        <div className="pl-4">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <div className="flex items-start">
                        <div className="shrink-0 bg-slate-100 rounded-lg p-3">
                            <HiOutlineInformationCircle size={35} color="black"></HiOutlineInformationCircle>
                        </div>
                        <div className="pl-4">
                    ...
                    <div className="flex items-start">
                        <div className="shrink-0 bg-slate-100 rounded-lg p-3">
                            <HiOutlineUserGroup size={35} color="black"></HiOutlineUserGroup>
                        </div>
                        <div className="pl-4">
